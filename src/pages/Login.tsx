...
const Login: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // In a real application, authentication would be implemented here
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 pr-3 py-2 border border-slate-300 rounded-md"
                  placeholder="admin@delhibus.com"
                />
              </div>
            </div>
